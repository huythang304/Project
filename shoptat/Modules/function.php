...
<?php
	if(isset($_GET['dieuhuong'])){
		switch($_GET['dieuhuong']){
			...
			case"cart": giohang();
				break;
			case"dssanpham": dssanpham();
				break;
			case"ttthanhvien": thongtintv();
				break;
			case"suathongtin": suathongtin();
				break;
			case"doimatkhau": suamatkhau();
				break;
			case"xemdonhang": xemdonhang();
				break;
			case"xemchitiethd": xemchitiethd();
				break;
			case"search": search();
				break;
			case"logout":
	...
	<section class="col-md-6 header-middle">
		<form action="?dieuhuong=search" method="post" style="border: #999 thin solid;">
			<section class="search">
				<input type="search" name="tukhoa" required placeholder="Tìm kiếm theo tên sản phẩm" value="<?php if(isset($_POST['tukhoa'])) echo $_POST['tukhoa'];if(isset($_GET['tukhoa'])) echo $_GET['tukhoa'];?>">
			</section>
	...
	<section class="col-md-3 header-right footer-bottom">
		<ul>
			...
			<li style="width: 46%; text-align: center;">
				<a href="?dieuhuong=login" class="item single-item hvr-outline-out button2"><i class="fa fa-user" aria-hidden="true">&nbsp;Đăng Nhập</i></a>
			</li>
			<li style="width: 46%; text-align: center;">
				<a href="?dieuhuong=login" class="item single-item hvr-outline-out button2"><i class="fa fa-user-plus" aria-hidden="true">&nbsp;Đăng Ký</i></a>
			</li>
			<?php }else{?>
			<li style="width: 62%; text-align: center;">
				<a href="?dieuhuong=ttthanhvien" class="item single-item hvr-outline-out button2"><i class="fa fa-user" aria-hidden="true">&nbsp;<?=$_SESSION['tendangnhap']?></i></a>
			</li>
			<li style="width: 30%; text-align: left;">
				<a href="?dieuhuong=logout" class="item single-item hvr-outline-out button2"><i class="fa fa-sign-out" aria-hidden="true">&nbsp;Thoát</i></a>
			</li>
			<?php } ?>
		</ul>
	</section>
		...
		<section class="navbar navbar-default">
			...
			<section class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
			  <ul class="nav navbar-nav menu__list">
				<li class="active menu__item menu__item--current"><a class="menu__link" href="?dieuhuong=home">Trang chủ <span class="sr-only">(current)</span></a></li>
				<?php
				...
				<li class="dropdown menu__item">
					<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?=$rownhomsp['tennhom']?> <span class="caret"></span></a>
						<ul class="dropdown-menu multi-column columns-3">
							<section class="row">
								...
								<section class="col-sm-6 multi-gd-img1 multi-gd-text ">
									<a href="?dieuhuong=dssanpham&manhom=<?=$rownhomsp['manhom']?>"><img src="images/<?=$rowanh['duongdananh']?>" alt=" "/></a>
								</section>
								<?php } ?>
								<section class="col-sm-4 multi-gd-img">
									<ul class="multi-column-dropdown">
									<?php
										$sql="select*from loaisp where trangthailoai=1 and manhomsp=".$rownhomsp['manhom'];
										GLOBAL $connect;
										$kq2=$connect->query($sql);
										while ($rowloaisp=mysqli_fetch_array($kq2)) {?>
										<li><a href="?dieuhuong=dssanpham&maloai=<?=$rowloaisp['maloai']?>"><?=$rowloaisp['tenloai']?></a></li>
										<?php } ?>
									</ul>
								</section>
								<section class="clearfix"></section>
	...
	<section class="top_nav_right">
		<section class="cart box_1">
					<a href="?dieuhuong=cart">
						<h3> <section class="total">
							<i class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></i>
							<span class="simpleCart_total"><?=$giohang?>  Sản phẩm</span>
						</h3>
					</a>
					<p><a  onClick="if(confirm('Bạn muốn xóa giỏ hàng?')) location='?dieuhuong=cart&hanhdong=delall&vitri=1';" class="simpleCart_empty">Xóa giỏ hàng</a></p>
		</section>
	</section>
	<section class="clearfix"></section>
</section>
				...
				<ul class="slide-group">
					<?php
						...
						while ($rowanhslideto=mysqli_fetch_array($kq)) {?>
							<li><img class="img-responsive" src="images/<?=$rowanhslideto['duongdananh']?>" alt="Dummy Image"/></li>
					<?php } ?>
				</ul>
					...
					<ul class="script-group">
						<?php
							...
							while ($rowanhslidenho=mysqli_fetch_array($kq1)) {?>
								<li><section class="inner-script"><img class="img-responsive" src="images/<?=$rowanhslidenho['duongdananh']?>" alt="Dummy Image" /></section></li>
						<?php } ?>
					</ul>
		...
		<section class="sap_tabs">
			<section id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
				<ul class="resp-tabs-list">
					...
					<li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span>Sản phẩm khuyến mại</span></li>
				</ul>
						...
						<section class="col-md-3 product-men" id="product-men-img">
							<section class="men-pro-item simpleCart_shelfItem">
								<section class="men-thumb-item" title="<?=$rowsanpham['tensanpham']?>">
									<img onClick="location='?dieuhuong=chitiet&masanpham=<?=$rowsanpham['masanpham']?>';" title="<?=$rowsanpham['tensanpham']?>" src="images/<?=$rowsanpham['anhdaidien']?>" alt="" class="pro-image-front">
									<img onClick="location='?dieuhuong=chitiet&masanpham=<?=$rowsanpham['masanpham']?>';" title="<?=$rowsanpham['tensanpham']?>"" src="images/<?=$rowsanpham['anhdaidien']?>" alt="" class="pro-image-back">
										<section class="men-cart-pro">
											<section class="inner-men-cart-pro">
												<a href="?dieuhuong=chitiet&masanpham=<?=$rowsanpham['masanpham']?>" class="link-product-add-cart">Xem chi tiết</a>
											</section>
										</section>
										<span class="product-new-top" id="product-new-new"><span class="product-new-span">NEW</span></span>
								</section>
								<section class="item-info-product ">
									...
									?>
										<span class="item_price">Giá: <?=number_format($gia,0,',','.')?> đ</span>
									</section>
									<a href="#" class="item single-item hvr-outline-out button2" onClick="location='?dieuhuong=chitiet&masanpham=<?=$rowsanpham['masanpham']?>';"><i class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></i> Thêm giỏ hàng</a>
								</section>
							</section>
						</section>
                        <?php
						...
						<section class="col-md-3 product-men" id="product-men-img">
							<section class="men-pro-item simpleCart_shelfItem">
								<section class="men-thumb-item" title="<?=$rowsanpham1['tensanpham']?>">
									<img onClick="location='?dieuhuong=chitiet&masanpham=<?=$rowsanpham1['masanpham']?>';" title="<?=$rowsanpham1['tensanpham']?>" src="images/<?=$rowsanpham1['anhdaidien']?>" alt="" class="pro-image-front">
									<img onClick="location='?dieuhuong=chitiet&masanpham=<?=$rowsanpham1['masanpham']?>';" title="<?=$rowsanpham1['tensanpham']?>"" src="images/<?=$rowsanpham1['anhdaidien']?>" alt="" class="pro-image-back">
										<section class="men-cart-pro">
											<section class="inner-men-cart-pro">
												<a href="?dieuhuong=chitiet&masanpham=<?=$rowsanpham1['masanpham']?>" class="link-product-add-cart">Xem chi tiết</a>
											</section>
										</section>
										<span class="product-new-top" id="product-new-hot"><span class="product-new-span">HOT</span></span>
								...
								<section class="item-info-product ">
									<section class="info-product-price">
										...
										?>
										<span class="item_price">Giá: <?=number_format($gia1,0,',','.')?> đ</span>
									</section>
									<a href="#" class="item single-item hvr-outline-out button2" onClick="location='?dieuhuong=chitiet&masanpham=<?=$rowsanpham1['masanpham']?>';"><i class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></i> Thêm giỏ hàng</a>
								</section>
							</section>
						</section>
            <?php
						...
						<section class="col-md-3 product-men" id="product-men-img">
							<section class="men-pro-item simpleCart_shelfItem">
								<section class="men-thumb-item" title="<?=$rowsanpham2['tensanpham']?>">
									<img onClick="location='?dieuhuong=chitiet&masanpham=<?=$rowsanpham2['masanpham']?>';" title="<?=$rowsanpham2['tensanpham']?>" src="images/<?=$rowsanpham2['anhdaidien']?>" alt="" class="pro-image-front">
									<img onClick="location='?dieuhuong=chitiet&masanpham=<?=$rowsanpham2['masanpham']?>';" title="<?=$rowsanpham2['tensanpham']?>"" src="images/<?=$rowsanpham2['anhdaidien']?>" alt="" class="pro-image-back">
										<section class="men-cart-pro">
											<section class="inner-men-cart-pro">
												<a href="?dieuhuong=chitiet&masanpham=<?=$rowsanpham2['masanpham']?>" class="link-product-add-cart">Xem chi tiết</a>
											</section>
										</section>
										<span class="product-new-top" id="product-new-sale"><span class="product-new-span"><?=$rowsanpham2['khuyenmai']?>%</span></span>
								</section>
								<section class="item-info-product">
									<section class="info-product-price">
										<?php
										...
										?>
										<span class="item_price">Giá: <?=number_format($gia2,0,',','.')?> đ</span>
									</section>
									<a href="#" class="item single-item hvr-outline-out button2" onClick="location='?dieuhuong=chitiet&masanpham=<?=$rowsanpham2['masanpham']?>';"><i class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></i> Thêm giỏ hàng</a>
								</section>
							</section>
						</section>
                        <?php
		...
		<section class="contact-grids">
			...
			<section class="col-md-4 contact-grid text-center animated wow slideInRight" data-wow-delay=".5s">
				<section class="contact-grid3">
					...
					<h4>Email</h4>
					<p><a href="tuanahhh@gmail.com">tuanahhh@gmail.com</a><span><a href="shoptat@gmail.com">shoptat@gmail.com</a></span></p>
				</section>
			</section>
			<section class="clearfix"> </section>
		</section>
	...
	<section class="container">
		<h3 style="color:red;text-align:center;font-weight:bold;font-size:30px;">Giỏ hàng của tôi</h3>
		 <?php if(!isset($cart) || $cart==NULL){?>
				<section style="text-align:center;font-weight:bold;font-size:30px;">Không có sản phẩm nào trong giỏ hàng</section>
				<?php }else{?>
				...
				?>
					<tr>
						<td class="invert-image">
							<img src="images/<?=$rowsanpham['anhdaidien']?>" alt="" class="img-responsive"/>
						</td>
						<td class="invert"><a href="?dieuhuong=chitiet&masanpham=<?=$rowsanpham['masp']?>"><?=$rowsanpham['tensanpham']?></a></td>
						...
						<td class="invert">
							<input type="number" name="<?=$rowsanpham['machitiet']?>" min="1" max="99" value="<?=$cart[$rowsanpham['machitiet']]?>" class="soluongajax">
						</td>
						<td class="invert" style="color: rgba(247, 40, 40, 0.92);font-weight: bold;" id="thanhtienajax"><?=number_format($thanhtien,0,',','.')?> vnđ</td>
						<td><a onClick="if(confirm('Bạn muốn xóa sản phẩm này?')) return true; else return false;" href="?dieuhuong=cart&hanhdong=del&machitiet=<?=$rowsanpham['machitiet']?>"><button type="button" class="btn btn-xs btn-warning"><span class="fa fa-trash"></span> Xóa</button></a></td>
					</tr>
					<?php } ?>
					<tr>
						<td colspan="11" id="sum-pro">Tổng chi phí: <span><?=number_format($tongtien,0,',','.')?> vnđ</span></td>
					</tr>
				</tbody>
			</table>
		</section>
		<section class="checkout-left" style="">
			...
			<section class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
				<input type="button" onClick="if(confirm('Bạn muốn xóa giỏ hàng?')) location='?dieuhuong=cart&hanhdong=delall';" value="Xóa giỏ hàng" class="btn btn-default">
			</section>
            <section class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
				<input type="button" onClick="location='?dieuhuong=cart&hanhdong=order'" value="Đặt hàng" class="btn btn-default">
			</section>
			<section class="clearfix"> </section>
		</section>
		</form>
	...
	<section class="col-md-9 footer-right">
		<section class="sign-grds">
			<section class="col-md-4 sign-gd">
				...
				<ul>
					...
					<?php
						...
						$kq=$connect->query($sql);
						while ($rownhomsp=mysqli_fetch_array($kq)) {?>
					<li><span class="fa fa-caret-right"></span> <a href="?dieuhuong=dssanpham&manhom=<?=$rownhomsp['manhom']?>"><?=$rownhomsp['tennhom']?></a></li>
					<?php } ?>
			...
			<section class="col-md-4 sign-gd-two">
				...
				<ul>
					<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Địa chỉ: 19, Nguyễn Trãi, Thanh Xuân <span>Hà Nội.</span></li>
					<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>Email : <a href="mailto:shoptat@gmail.com">shoptat@gmail.com</a></li>
					<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>Phone : 01672923739</li>
				</ul>
			</section>
			<section class="col-md-4 sign-gd-two">
				<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fshoptat&tabs=timeline&width=340&height=500&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="340" height="300" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
			</section>
			<section class="clearfix"></section>
		</section>
	</section>
			...
			<section class="login-right">
					...
					<form method="post" id="signinForm">
						<section class="sign-in">
							<h4>Tên đăng nhập :</h4>
							<input type="text" name="tendangnhaplogin" placeholder="Mời nhập tên đăng nhập" value="<?php if(isset($tendangnhaplogin)) echo $tendangnhaplogin;?>">
						</section>
						<section class="sign-in">
							<h4>Mật khẩu :</h4>
							<input type="password" name="matkhaulogin" placeholder="Mời nhập mật khẩu" value="<?php if(isset($_POST['matkhaulogin'])) echo $_POST['matkhaulogin'];?>">
						</section>
						<section class="sign-in">
							<em id="login-error" class="error help-block"><?php if(isset($UserError)) echo $UserError; ?></em>
				...
				<section class="login-bottom">
					...
					<form method="post" id="signupForm">
						<section class="sign-up">
							<h4>Họ tên :</h4>
							<input type="text" name="hoten" id="hoten" value="<?php if(isset($hoten)) echo $hoten?>" placeholder="Mời nhập họ tên">
						</section>
						<section class="sign-up">
							<h4>Tên đăng nhập :</h4>
							<input type="text" name="tendangnhap" id="tendangnhap" value="<?php if(isset($tendangnhap)) echo $tendangnhap?>" placeholder="Mời nhập tên đăng nhập">
                            <em id="login-error" class="error help-block"><?php if(isset($UserError1)) echo $UserError1; ?></em>
						</section>
						<section class="sign-up">
							<h4>Mật khẩu :</h4>
							<input type="password" name="matkhau" id="matkhau" value="<?php if(isset($_POST['matkhau'])) echo $_POST['matkhau']?>" placeholder="Mời nhập mật khẩu">
						</section>
						<section class="sign-up">
							<h4>Nhập lại mật khẩu :</h4>
							<input type="password" name="rematkhau" id="rematkhau" value="<?php if(isset($_POST['rematkhau'])) echo $_POST['rematkhau']?>" placeholder="Mời nhập lại mật khẩu">
						</section>
						<section class="sign-up">
							<h4>Điện thoại :</h4>
							<input type="text" name="phone" id="phone" value="<?php if(isset($dienthoai)) echo $dienthoai?>" placeholder="Mời nhập điện thoại">
                            <em id="login-error" class="error help-block"><?php if(isset($DienThoaiError1)) echo $DienThoaiError1; ?></em>
						</section>
						<section class="sign-up">
							<h4>Email :</h4>
							<input type="text" name="email" id="email" value="<?php if(isset($email)) echo $email?>" placeholder="Mời nhập email">
                            <em id="login-error" class="error help-block"><?php if(isset($EmailrError1)) echo $EmailrError1; ?></em>
						</section>
						<section class="sign-up">
							<h4>Địa chỉ :</h4>
							<input type="text" name="diachi" id="diachi" class="form-control textboxlogin" value="<?php if(isset($diachi)) echo $diachi?>" placeholder="Mời nhập địa chỉ">
						</section>
						<section class="sign-up">
...
<section class="single">
	<section class="container">
		<section class="col-md-6 col-sm-12 single-right-left animated wow slideInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInUp;">
				...
				<section class="flexslider">
					...
					?>
							<li data-thumb="images/<?=$rowanhsp['duongdan']?>">
								<img src="images/<?=$rowanhsp['duongdan']?>" data-imagezoom="true" class="img-responsive" style="margin-left: auto; margin-right: auto;">
							</li>
							<?php }
						}else{?>
							<li data-thumb="images/<?=$rowsanpham['anhdaidien']?>">
								<img src="images/<?=$rowsanpham['anhdaidien']?>" data-imagezoom="true" class="img-responsive" style="margin-left: auto; margin-right: auto;">
							</li>
						<?php } ?>
					</ul>
					<section class="clearfix"></section>
		...
		<section class="col-md-6 col-sm-12 single-right-left simpleCart_shelfItem animated wow slideInRight animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInRight; padding-left: 20px">
			<h3><?=$rowsanpham['tensanpham']?></h3>
			<p><span class="item_price">Giá cũ:<del><?=number_format($rowsanpham['gia'],0,',','.')?> đ</del></span> </p>
			<?php $giamoi=$rowsanpham['gia']*(100-$rowsanpham['khuyenmai'])/100; ?>
			<p><span class="item_price">Giá ưu đãi: <span style="color: red; font-weight: bolder; font-size: 26px"><?=number_format($giamoi,0,',','.')?> đ</span></span> </p>
			...
			<section class="occasion-cart" style="margin-top: 10px">
				<span id="tenloai1-error" class="error help-block"><?php if(isset($erros)) echo $erros ?></span>
				<input type="submit" name="dathangsp" class="btn btn-warning" class="item hvr-outline-out button2" value="Thêm vào giỏ hàng">
			</section>
			<script type="text/javascript">
				$( document ).ready( function () {
					$( "#addsp" ).validate( {
		...
		<section class="bootstrap-tab animated wow slideInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInUp;">
			<section class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				...
				<section id="myTabContent" class="tab-content">
					<section role="tabpanel" class="tab-pane fade in active bootstrap-tab-text" id="home" aria-labelledby="home-tab">
						<?=$rowsanpham['motasp']?>
					</section>
					<section role="tabpanel" class="tab-pane fade bootstrap-tab-text" id="profile" aria-labelledby="profile-tab">
						<section class="bootstrap-tab-text-grids">
							...
							<section class="bootstrap-tab-text-grid">
								<section class="bootstrap-tab-text-grid-right alert alert-info">
									<ul>
										...
										<li><span class="fa fa-calendar" aria-hidden="true"></span> <?php echo date("d/m/Y",strtotime($rowbinhluan['ngaygui']))?></li>
									</ul>
							...
							<section class="add-review">
								...
								<form method="post" id="formbinhluan">
									<textarea type="text" name="noidungbinhluan" id="noidungbinhluan" rows="3"></textarea>
...
<section class="container">
    <ol class="breadcrumb" style="margin-bottom: 0px">
        ...
        ?>
    		<li><a href="?dieuhuong=dssanpham&manhom=<?=$rownhomsp['manhom']?>"><?=$rownhomsp['tennhom']?></a></li>
		...
		<section class="col-md-12 products-right">
			<section class="col-md-12 sort-grid">
				<section class="col-md-4 col-sm-6 col-xs-12">
					<section class="form-group input-group">
				            ...
				            <select class="form-control" name="gia" onChange="location=this.options[this.selectedIndex].value;">
				            <?php
							...
							?>
								<option selected value="?<?=$url?>&mucthap=<?=$rowmucgia['mucthap']?>&muccao=<?=$rowmucgia['muccao']?>"><?=$rowmucgia['tenmucgia']?></option>
							<?php
								}else{
							?>
			...
			<section class="col-md-4 col-sm-6 col-xs-12">
				<section class="form-group input-group">
		            ...
		            <select class="form-control" name="xep" onChange="location=this.options[this.selectedIndex].value;">
		            <?php
		            ...
		            <?php }elseif ($_GET['sapxep']==3) {?>
		            	<option value="?<?=$url?>&sapxep=1">Theo tên sản phẩm(Từ A-Z)</option>
		            	<option value="?<?=$url?>&sapxep=2">Theo tên sản phẩm(Từ Z-A)</option>
		            	<option selected value="?<?=$url?>&sapxep=3">Theo giá sản phẩm(Từ cao-thấp)</option>
		            	<option value="?<?=$url?>&sapxep=4">Theo giá sản phẩm(Từ thấp-cao)</option>
		             <?php }elseif ($_GET['sapxep']==4) {?>
		            	<option value="?<?=$url?>&sapxep=1">Theo tên sản phẩm(Từ A-Z)</option>
		            	<option value="?<?=$url?>&sapxep=2">Theo tên sản phẩm(Từ Z-A)</option>
		            	<option value="?<?=$url?>&sapxep=3">Theo giá sản phẩm(Từ cao-thấp)</option>
		            	<option selected value="?<?=$url?>&sapxep=4">Theo giá sản phẩm(Từ thấp-cao)</option>
		             <?php }else{?>
		            	<option value="?<?=$url?>&sapxep=1">Theo tên sản phẩm(Từ A-Z)</option>
		            	<option value="?<?=$url?>&sapxep=2">Theo tên sản phẩm(Từ Z-A)</option>
		            	<option value="?<?=$url?>&sapxep=3">Theo giá sản phẩm(Từ cao-thấp)</option>
			...
			<section class="clearfix"></section>
						...
						<section class="col-lg-12" style="text-align: center; font-size: 20px; color: #FDA30E; font-weight: bolder;">
			...
			<section class="col-md-3 product-men" id="product-men-img">
				<section class="men-pro-item simpleCart_shelfItem">
					<section class="men-thumb-item">
						<img src="images/<?=$rowsanpham['anhdaidien']?>" alt="" title="<?=$rowsanpham['tensanpham']?>" class="pro-image-front">
						<img src="images/<?=$rowsanpham['anhdaidien']?>" alt="" title="<?=$rowsanpham['tensanpham']?>" class="pro-image-back">
						<section class="men-cart-pro">
							<section class="inner-men-cart-pro">
								<a href="?dieuhuong=chitiet&masanpham=<?=$rowsanpham['masanpham']?>" class="link-product-add-cart">Xem nhanh</a>
							</section>
						</section>
					</section>
					<section class="item-info-product ">
						<section class="info-product-price">
							<span class="item_price">Giá: <?=number_format($rowsanpham['gia'],0,',','.')?> đ</span>
						</section>
						<a href="#" class="item single-item hvr-outline-out button2" onClick="location='?dieuhuong=chitiet&masanpham=<?=$rowsanpham['masanpham']?>';"><i class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></i> Thêm giỏ hàng</a>
					</section>
				</section>
			...
			<section class="col-md-3 product-men" id="product-men-img">
				<section class="men-pro-item simpleCart_shelfItem">
					...
					<section class="item-info-product ">
						...
						<a href="#" class="item single-item hvr-outline-out button2" onClick="location='?dieuhuong=chitiet&masanpham=<?=$rowsanpham['masanpham']?>';"><i class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></i> Đặt hàng</a>
					</section>
				</section>
			</section>
            <?php
			...
			<section class="login-right">
				<h3><span class="glyphicon glyphicon-user"></span> Thông tin người đặt</h3>
					<section class="sign-in">
						...
						<input type="text" class="order-c" name="tennguoidat" value="<?=$rowthanhvien['hoten']?>" disabled>
					</section>
					<section class="sign-in">
						<h4>Địa chỉ người đặt :</h4>
						<input type="text" class="order-c" name="diachinguoidat" value="<?=$rowthanhvien['diachi']?>" disabled>
					</section>
					<section class="sign-in">
						<h4>Điện thoại người đặt :</h4>
						<input type="text" class="order-c" name="dienthoainguoidat" value="<?=$rowthanhvien['dienthoai']?>" disabled>
					</section>
					<section class="sign-in">
						<h4>Email người đặt :</h4>
						<input type="text" class="order-c" name="emailnguoidat" value="<?=$rowthanhvien['email']?>" disabled>
					</section>
			</section>
			<section class="login-bottom">
				<h3><span class="glyphicon glyphicon-user"></span> Thông tin người nhận</h3>
					<section class="sign-up">
						...
						<input type="text" name="hotennguoinhan" id="hoten" placeholder="Mời nhập họ tên người nhận" value="<?=$rowthanhvien['hoten']?>">
					</section>
					<section class="sign-up">
						<h4>Địa chỉ người nhận :</h4>
						<input type="text" name="diachinguoinhan" id="diachi" placeholder="Mời nhập địa chỉ người nhận chính xác" value="<?=$rowthanhvien['diachi']?>">
					</section>
					<section class="sign-up">
						<h4>Điện thoại người nhận :</h4>
						<input type="tel" name="dienthoainguoinhan" id="dienthoai" placeholder="Mời nhập điện thoại người nhận" value="<?=$rowthanhvien['dienthoai']?>">
					</section>
					<section class="sign-up">
						<h4>Email người nhận :</h4>
						<input type="email" name="emailnguoinhan" id="email" placeholder="Mời nhập Email người nhận" value="<?=$rowthanhvien['email']?>">
					</section>
					<section class="sign-up">
						<h4>Ghi chú:</h4>
	        ...
	        <form method="post" class="form-horizontal" id="signupForm" enctype="multipart/form-data">
		        <section class="form-group">
	            	...
	            	<section class="col-md-10 col-sm-12">
		              	  <input class="form-control" type="text" name="tensp" value="<?php echo date('d/m/Y',strtotime($rowthanhvien['ngaytao']))?>" disabled>
                	</section>
	            </section>
	            <section class="form-group">
	            ...
	            <section class="form-group">
	            	...
	            	<section class="col-md-10 col-sm-12">
		              	  <input class="form-control" type="text" name="tensp" value="<?=$rowthanhvien['email']?>" disabled>
                	</section>
	            </section>
	            <section class="form-group">
	                <label class="control-label col-md-2 col-sm-12" id="label2">Điện thoại: </label>
	            	<section class="col-md-10 col-sm-12">
		              	  <input class="form-control" type="text" name="tensp" value="<?=$rowthanhvien['dienthoai']?>" disabled>
                	</section>
	            </section>
	            <section class="form-group">
	                <label class="control-label col-md-2 col-sm-12" id="label2">Địa chỉ: </label>
	            	<section class="col-md-10 col-sm-12">
		                <textarea class="form-control" type="text" name="noidung" id="motasp" disabled=""><?=$rowthanhvien['diachi']?></textarea>
	                </section>
	            </section>
	            <section class="form-group" id="b-align">
                	<section class="col-md-12 col-sm-12">
							<input type="button" onClick="location='?dieuhuong=suathongtin';" class="btn btn-warning" value="Sửa thông tin" id="button-button">
		            		<input type="button" onClick="location='?dieuhuong=doimatkhau';" class="btn btn-warning" name="themsanpham" value="Sửa mật khẩu" id="button-button">
		            		<input type="button" onClick="location='?dieuhuong=xemdonhang';" class="btn btn-warning" name="xoa" value="Xem đơn hàng" id="button-button">
	            	</section>
		        </section>
	        </form>
		</section>
		...
		<section class="col-lg-12">
	        ...
	        <form method="post" class="form-horizontal" id="signupForm" enctype="multipart/form-data">
	            ...
	            <section class="form-group">
	                <label class="control-label col-md-2 col-sm-12" id="label2">Tên thành viên: </label>
	            	<section class="col-md-10 col-sm-12">
		                <input class="form-control" type="text" name="hoten" value="<?php if(isset($hoten)) echo $hoten;else echo $rowthanhvien['hoten']?>">
	                </section>
	            </section>
	            <section class="form-group">
	                <label class="control-label col-md-2 col-sm-12" id="label2">Email: </label>
	            ...
	            <section class="form-group">
	                <label class="control-label col-md-2 col-sm-12" id="label2">Điện thoại: </label>
	            	<section class="col-md-10 col-sm-12">
		              	  <input class="form-control" type="text" name="phone" value="<?php if(isset($dienthoai)) echo $dienthoai;else echo $rowthanhvien['dienthoai']?>">
		              	  <em id="phone1-error" class="error help-block"><?php if(isset($DienThoaiError1)) echo $DienThoaiError1; ?></em>
                	</section>
	            </section>
	            <section class="form-group">
	                <label class="control-label col-md-2 col-sm-12" id="label2">Địa chỉ: </label>
	            	<section class="col-md-10 col-sm-12">
		                <textarea class="form-control" type="text" name="diachi" id="diachi"><?php if(isset($diachi)) echo $diachi;else echo $rowthanhvien['diachi']?></textarea>
	                </section>
	            </section>
	            <section class="form-group" id="b-align">
                	<section class="col-md-12 col-sm-12">
							<input type="button" onClick="location='?dieuhuong=ttthanhvien';" class="btn btn-warning" value="Quay lại" id="button-button">
		            		<input type="submit" class="btn btn-warning" name="suathongtin" value="Thay đổi" id="button-button">
	            	</section>
		        </section>
	        </form>
		</section>
	        ...
	        <form method="post" class="form-horizontal" id="signupForm" enctype="multipart/form-data">
		        <section class="form-group">
	            	...
	            	<section class="col-md-9 col-sm-12">
		              	  <input class="form-control" type="password" name="matkhaucu" placeholder="Mời bạn nhập mật khẩu cũ">
		              	  <em id="matkhaucu1-error" class="error help-block"><?php if(isset($Matkhaucuerror)) echo $Matkhaucuerror; ?></em>
                	</section>
	            </section>
	            <section class="form-group">
	                <label class="control-label col-md-3 col-sm-12" id="label2">Mật khẩu mới: </label>
	            	<section class="col-md-9 col-sm-12">
		                <input class="form-control" type="password" name="matkhaumoi" id="matkhaumoi" placeholder="Mời bạn nhập mật khẩu mới">
	                </section>
	            </section>
	            <section class="form-group">
	                <label class="control-label col-md-3 col-sm-12" id="label2">Nhập lại mật khẩu mới: </label>
	            	<section class="col-md-9 col-sm-12">
		              	  <input class="form-control" type="password" name="rematkhaumoi" placeholder="Mời bạn nhập lại mật khẩu mới">
                	</section>
	            </section>
	            <section class="form-group" id="b-align">
                	<section class="col-md-12 col-sm-12">
							<input type="button" onClick="location='?dieuhuong=ttthanhvien';" class="btn btn-warning" value="Quay lại" id="button-button">
		            		<input type="submit" class="btn btn-warning" name="suamatkhau" value="Sửa mật khẩu" id="button-button">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo date("d-m-Y",strtotime($rowhoadon['ngaytao']))?></td>
                       	...
                       	<td>
                       		 <a href="?dieuhuong=xemchitiethd&mahoadon=<?=$rowhoadon['mahoadon']?>"><button type="button" class="btn btn-xs btn-primary"><span class="fa fa-pencil"></span> Xem - Sửa</button></a>
                       	</td>
                    </tr>
                    <?php }
                    	}else{?>
		...
		<form method="post" id="orderForm">
			<section class="login">
				<section class="login-right">
					...
					<section class="sign-in">
						<h4>Họ tên người đặt :</h4>
						<input type="text" class="order-c" name="tennguoidat" value="<?=$rowhoadon['hoten']?>" disabled>
					</section>
					<section class="sign-in">
						<h4>Địa chỉ người đặt :</h4>
						<input type="text" class="order-c" name="diachinguoidat" value="<?=$rowhoadon['diachi']?>" disabled>
					</section>
					<section class="sign-in">
						<h4>Điện thoại người đặt :</h4>
						<input type="text" class="order-c" name="dienthoainguoidat" value="<?=$rowhoadon['dienthoai']?>" disabled>
					</section>
					<section class="sign-in">
						<h4>Email người đặt :</h4>
						<input type="text" class="order-c" name="emailnguoidat" value="<?=$rowhoadon['email']?>" disabled>
					</section>
				</section>
					<section class="login-bottom">
						<h3><span class="glyphicon glyphicon-user"></span> Thông tin người nhận</h3>
						<section class="sign-up">
							<h4>Họ tên người nhận :</h4>
							<input type="text" class="order-c" name="hotennguoinhan" id="hoten" value="<?=$rowhoadon['hoten']?>" disabled>
						</section>
						<section class="sign-up">
							<h4>Địa chỉ người nhận :</h4>
							<input type="text" class="order-c" name="diachinguoinhan" id="diachi" value="<?=$rowhoadon['diachi']?>" disabled>
						</section>
						<section class="sign-up">
							<h4>Điện thoại người nhận :</h4>
							<input type="text" class="order-c" name="dienthoainguoinhan" id="dienthoai" value="<?=$rowhoadon['dienthoai']?>" disabled>
						</section>
						<section class="sign-up">
							<h4>Email người nhận :</h4>
							<input type="text" class="order-c" name="emailnguoinhan" id="email" value="<?=$rowhoadon['email']?>" disabled>
						</section>
						<?php
						...
						?>
							<section class="sign-up">
								<h4>Ghi chú:</h4>
								<textarea class="order-c" name="ghichu" id="ghichu" ><?=$rowhoadon['ghichu']?></textarea>
							</section>
						<?php } ?>					
					</section>
					<section class="login-right">
						...
						<section class="sign-up">
							<h4>Phương thức thanh toán :</h4>
							<input type="text" class="order-c" name="emailnguoinhan" id="email" value="<?=$rowhoadon['hinhthuctt']?>" disabled>
						</section>
					</section>
					<section class="login-bottom">
						<h3><span class="glyphicon glyphicon-user"></span> Phương thức vận chuyển</h3>
						<section class="sign-up">
							<h4>Phương thức vận chuyển :</h4>
							<input type="text" class="order-c" name="emailnguoinhan" id="email" value="<?=$rowhoadon['hinhthucvc']?>" disabled>
						</section>
					</section>
				          	...
				          	<table class="table table-bordered table-hover">
				                ...
				                <tbody>
									...
									?>
										<tr>
					                		<td><?=++$stt;?></td>
						                    <td><img src="images/<?=$rowchitiet['anhdaidien']?>" width="80px" height="100px" class="img-responsive"></td>
				    ...
				    <section class="col-lg-12">
			            <ul class="list-group" style="text-align: right; font-weight: bolder;margin-bottom: 10px">
			                <li class="list-group-item" style="font-weight: none;">Tổng tiền hàng: <?=number_format($tongtien,0,',','.')?> vnđ</li>
			                <li class="list-group-item" style="font-weight: none;">Tiền vận chuyển: <?=number_format($rowhoadon['giacuoc'],0,',','.')?> vnđ</li>
				    ...
				    <section class="col-lg-12" style="margin-bottom: 10px">
						<section class="form-group">
							<label class="control-label col-md-2 col-sm-12" style="font-weight: none">Trạng thái hóa đơn: </label>
